...
--Makefile shortcuts
vim.keymap.set("n", "<leader>mb", "<cmd>!cd build && make<cr>", { desc = "make current file" })
vim.keymap.set("n", "<leader>md", '<cmd>make "%:r.debug"<cr>', { desc = "make current debug file" })
vim.keymap.set("n", "<leader>mc", "<cmd>!cd build && make clean<cr>", { desc = "make clean the executable" })
vim.keymap.set("n", "<leader>mr", "<cmd>!./build/main<cr>", { desc = "make run the executable" })
vim.keymap.set("n", "<leader>ma", "<cmd>!cd build && make && ./main<cr>", { desc = "run and build" })
