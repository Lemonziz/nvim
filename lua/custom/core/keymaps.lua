...
vim.keymap.set('n', '<leader>sh', '<C-w>s', {desc = "Split window below"})
vim.keymap.set('n', '<leader>se', '<C-w>=', {desc = "Make split equal size"})
vim.keymap.set('n', '<leader>sx', '<cmd>close<cr>', {desc = "Close current split"})
vim.keymap.set('n', '<leader>sp', '<cmd>rightb vert sbp<cr>', {desc = "show previous split"})
...
vim.keymap.set('t', '<left>',  '<cmd>echoe "Use h"<cr>')
vim.keymap.set('t', '<right>', '<cmd>echoe "Use l"<cr>')
vim.keymap.set('t', '<up>'  ,  '<cmd>echoe "Use k"<cr>')
vim.keymap.set('t', '<down>',  '<cmd>echoe "Use j"<cr>')
